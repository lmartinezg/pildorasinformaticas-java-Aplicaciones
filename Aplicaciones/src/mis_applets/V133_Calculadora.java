...
//
// Video 133
// Convertir la calculadora en applet
...
public class V133_Calculadora extends JApplet {
	...
	public void init() {
		...
		// V133_Marco_Calculadora marco = new V133_Marco_Calculadora();
		...
		V133_Lamina_Calculadora milamina = new V133_Lamina_Calculadora();
		add(milamina);
...
// class V133_Marco_Calculadora extends JFrame {
//
// public V133_Marco_Calculadora() {
//
//
// setTitle("Calculadora");
// setBounds(500, 300, 450, 300);
...
class V133_Lamina_Calculadora extends JPanel {

	public V133_Lamina_Calculadora() {
